...
<html lang="pt-br">
  ...
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control" id="inputAddress2" placeholder="ex: Próximo ao banco do Brasil">
  </div>
    <div class="form-group col-md-6">
...
<div class="custom-control custom-checkbox">
  ...
  <label class="custom-control-label" for="customCheckcom5">Shop</label>
    ...
    <div>
    <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Em ocupação</label>
